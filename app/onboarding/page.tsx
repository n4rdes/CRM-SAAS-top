...
export default async function OnboardingPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="auth-page">
      <aside className="auth-aside"><div className="auth-brand">prismae</div><div className="auth-aside-copy"><small>Configuração inicial</small><h1>Vamos criar o ambiente da sua empresa.</h1><p>Você será o proprietário e poderá convidar sua equipe depois.</p></div></aside>
